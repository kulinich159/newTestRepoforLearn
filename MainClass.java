import currency.CanadianDollar;
...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        Logger logger = Logger.getLogger("MainClass"); // вызов обьекта или екземпляра класа логера
...
//        ourListList.add(lineList); // - добавляет ссылку на область памяти где это хранится
        ...
        logger.info("Euro currency = " + euro.getKursNBU());
        euro.setKursNBU(32);
